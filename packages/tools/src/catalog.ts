...
export const TOOLS: readonly ToolDefinition[] = [
  ...
  { name: "bridgistic_get_post", scope: "posts:read", route: "posts/{id}", method: "GET", group: "content" },
  { name: "bridgistic_create_post", scope: "posts:write", route: "posts", method: "POST", group: "content" },
  { name: "bridgistic_update_post", scope: "posts:write", route: "posts/{id}", method: "POST", group: "content" },
  { name: "bridgistic_delete_post", scope: "posts:write", route: "posts/{id}", method: "DELETE", group: "content" },
  ...
  { name: "bridgistic_delete_media", scope: "media:write", route: "media/{id}", method: "DELETE", group: "content" },
  ...
  { name: "bridgistic_update_user", scope: "users:write", route: "users/{id}", method: "POST", group: "content" },
  ...
  { name: "bridgistic_fs_list", scope: "fs:read", route: "fs/list", method: "POST", group: "admin" },
  { name: "bridgistic_fs_read", scope: "fs:read", route: "fs/read", method: "POST", group: "admin" },
  ...
  // ---- safety -------------------------------------------------------------
  { name: "bridgistic_snapshot_create", scope: "snapshot:manage", snapshotOperation: "create", route: "snapshot", method: "POST", group: "safety" },
  { name: "bridgistic_snapshot_restore", scope: "snapshot:manage", snapshotOperation: "restore", route: "snapshot/restore", method: "POST", group: "safety" },
  { name: "bridgistic_snapshot_list", scope: "snapshot:manage", snapshotOperation: "list", readOnlyOperation: true, route: "snapshot", method: "GET", group: "safety" },
  { name: "bridgistic_snapshot_delete", scope: "snapshot:manage", snapshotOperation: "delete", route: "snapshot/delete", method: "POST", group: "safety" },
  { name: "bridgistic_approval_status", scope: "site:read", route: "approvals/status", method: "GET", group: "safety" },
  ...
  { name: "bridgistic_woo_get_product", scope: "woo:products:read", route: "woo/products/{id}", method: "GET", group: "woo" },
  { name: "bridgistic_woo_create_product", scope: "woo:products:write", route: "woo/products", method: "POST", group: "woo" },
  { name: "bridgistic_woo_update_product", scope: "woo:products:write", route: "woo/products/{id}", method: "POST", group: "woo" },
  { name: "bridgistic_woo_list_orders", scope: "woo:orders:read", route: "woo/orders", method: "GET", group: "woo" },
  { name: "bridgistic_woo_get_order", scope: "woo:orders:read", route: "woo/orders/{id}", method: "GET", group: "woo" },
  { name: "bridgistic_woo_update_order_status", scope: "woo:orders:write", route: "woo/orders/{id}/status", method: "POST", group: "woo" },
  { name: "bridgistic_woo_list_customers", scope: "woo:customers:read", route: "woo/customers", method: "GET", group: "woo" },
  { name: "bridgistic_woo_get_customer", scope: "woo:customers:read", route: "woo/customers/{id}", method: "GET", group: "woo" },
  { name: "bridgistic_woo_inventory_status", scope: "woo:analytics:read", route: "woo/inventory", method: "GET", group: "woo" },
  { name: "bridgistic_woo_sales_summary", scope: "woo:analytics:read", route: "woo/sales-summary", method: "GET", group: "woo" },
] as const;
